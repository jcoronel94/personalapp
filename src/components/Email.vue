  ...
  <form class="contact-form" @submit.prevent="validateMessage">
      ...
      <div class="md-layout md-gutter">
        ...
        <md-field :class="getValidationClass('userName')">
          ...
          <md-input name="user_name" id="user_name" v-model="form.userName" :disabled="sending" />
          <span class="md-error" v-if="!$v.form.userName.required">A name is required</span>
          <!-- <span class="md-error" v-else-if="!$v.form.userName.minlength">Invalid first name</span> -->
        </md-field>
    
        <md-field :class="getValidationClass('email')">
          <label for="user_email">Email</label>
          <md-input type="email" name="user_email" id="user_email" autocomplete="user_email" v-model="form.email" :disabled="sending" />
          <span class="md-error" v-if="!$v.form.email.required">An email is required</span>
          <span class="md-error" v-else-if="!$v.form.email.email">Invalid email</span>
        </md-field>

        <md-field :class="getValidationClass('message')" >
          <label for="message">Message</label>
          <md-textarea :disabled="sending" 
          id="message" 
          name="message" 
          v-model="form.message" md-autogrow />
          <span class="md-error" v-if="!$v.form.message.required">A message is required</span>
        </md-field>
